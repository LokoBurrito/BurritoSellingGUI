...
local Window = Library.CreateLib("Burrito's Selling GUI", getgenv().Theme)
...
Section:NewButton("Burrito's DHC Counter", "Counts the DHC on ground", function()
 _G.Text = 'Burritos Cash Counter'
...
print("Thanks for using Burrito's Seller GUI!")
local Tab = Window:NewTab("Credits")
local a = Tab:NewSection("Credits:")
a:NewLabel("Made By: LokoBurrito")
